...
INSERT INTO test.rules (id, name, description, effective_from, created_by, created_at, updated_at) VALUES
...
SELECT setval('test.rules_id_seq', 2, true);
