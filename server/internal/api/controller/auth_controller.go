...
func (a *AuthController) Signup(ctx *gin.Context) {
	...
	ctx.SetCookie("access_token", authResponse.AccessToken, int(a.cfg.AccessTokenDuration.Seconds()), "/", "", true, true)
	ctx.SetCookie("refresh_token", authResponse.RefreshToken, int(a.cfg.RefreshTokenDuration.Seconds()), "/", "", true, true)
