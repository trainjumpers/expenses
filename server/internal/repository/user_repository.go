...
*/
func (u *UserRepository) CreateUser(ctx context.Context, newUser models.CreateUserInput) (models.UserResponse, error) {
	var user models.UserResponse
	query, values, ptrs, err := helper.CreateInsertQuery(&newUser, &user, u.tableName, u.schema)
	if err != nil {
		return models.UserResponse{}, err
	}
	err = u.db.FetchOne(ctx, query, values...).Scan(ptrs...)
	if err != nil {
		return models.UserResponse{}, err
	}
	return user, nil
...
*/
func (u *UserRepository) GetUserByEmailWithPassword(ctx context.Context, email string) (models.UserWithPassword, error) {
	...
	err = u.db.FetchOne(ctx, query, email).Scan(ptrs...)
	if err != nil {
...
returns: User object of the fetched user with password
*/
func (u *UserRepository) GetUserByIdWithPassword(ctx context.Context, userId int64) (models.UserWithPassword, error) {
	var user models.UserWithPassword
	ptrs, dbFields, err := helper.GetDbFieldsFromObject(&user)
	if err != nil {
		return models.UserWithPassword{}, err
	...
	err = u.db.FetchOne(ctx, query, userId).Scan(ptrs...)
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) {
			return models.UserWithPassword{}, commonErrors.NewUserNotFoundError(err)
		}
...
*/
func (u *UserRepository) GetUserById(ctx context.Context, userId int64) (models.UserResponse, error) {
	var user models.UserResponse
	ptrs, dbFields, err := helper.GetDbFieldsFromObject(&user)
	if err != nil {
		return models.UserResponse{}, err
...
func (u *UserRepository) DeleteUser(ctx context.Context, userId int64) error {
	...
	rowsAffected, err := u.db.ExecuteQuery(ctx, query, userId)
	if err != nil {
		return err
	}
...
*/
func (u *UserRepository) UpdateUser(ctx context.Context, userId int64, updatedUser models.UpdateUserInput) (models.UserResponse, error) {
	...
	err = u.db.FetchOne(ctx, query, append(argValues, userId)...).Scan(ptrs...)
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) {
			return models.UserResponse{}, commonErrors.NewUserNotFoundError(err)
		}
...
returns: User object of the updated user
*/
func (u *UserRepository) UpdateUserPassword(ctx context.Context, userId int64, password string) (models.UserResponse, error) {
	var user models.UserResponse
	ptrs, dbFields, err := helper.GetDbFieldsFromObject(&user)
	if err != nil {
		return models.UserResponse{}, err
	...
	err = u.db.FetchOne(ctx, query, password, userId).Scan(ptrs...)
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) {
			return models.UserResponse{}, commonErrors.NewUserNotFoundError(err)
		}
