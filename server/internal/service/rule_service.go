...
type ruleService struct {
	...
	engineService   RuleEngineServiceInterface
}

func NewRuleService(ruleRepo repository.RuleRepositoryInterface, transactionRepo repository.TransactionRepositoryInterface, categoryRepo repository.CategoryRepositoryInterface, db database.DatabaseManager) RuleServiceInterface {
	engineService := NewRuleEngineService(ruleRepo, transactionRepo, categoryRepo)
	return &ruleService{
		ruleRepo:        ruleRepo,
...
func (s *ruleService) ExecuteRules(c *gin.Context, userId int64, request models.ExecuteRulesRequest) (models.ExecuteRulesResponse, error) {
	return s.engineService.ExecuteRules(c, userId, request)
}

func (s *ruleService) ExecuteRulesForTransaction(c *gin.Context, transactionId int64, userId int64) (models.ExecuteRulesResponse, error) {
	return s.engineService.ExecuteRulesForTransaction(c, transactionId, userId)
}

func (s *ruleService) ExecuteRulesForRule(c *gin.Context, ruleId int64, userId int64) (models.ExecuteRulesResponse, error) {
	return s.engineService.ExecuteRulesForRule(c, ruleId, userId)
}
